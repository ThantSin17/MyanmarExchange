 ...
 */
public class MobBank extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_mob_bank, container, false);
    }
    @Override
    ...
    private void showSnackBar(){
        ...
        snackbar=Snackbar.make(getView(), "Can't load data kbz....", Snackbar.LENGTH_INDEFINITE)
                .setAction("Retry", new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        new JsonFetch().execute("https://networkingstone.000webhostapp.com/bank/mob.php");
                    }
                });
        snackbar.show();
