 ...
 */
public class MwdBank extends Fragment {
    ...
    Snackbar snackbar;
    int[] imgList = new int[]{R.drawable.ic1, R.drawable.ic2, R.drawable.ic3, R.drawable.ic23};
    public MwdBank() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_mwd_bank, container, false);
    }
    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
       ...
       // new JsonFetch().execute("https://networkingstone.000webhostapp.com/bank/mwd.php");
    }
