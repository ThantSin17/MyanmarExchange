 ...
 */
public class YomaBank extends Fragment {
    ...
    Snackbar snackbar;
    int[] imgList = new int[]{R.drawable.ic1,  R.drawable.ic2,R.drawable.ic3,R.drawable.ic18, R.drawable.ic23};
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_yoma_bank, container, false);
    }
    @Override
    ...
    private ArrayList<Currency> getCurrency() {
        ...
        currencies.add(new Currency("Malaysian Ringgit", "MYR", "50,00", "21,00"));
...
//            Toast.makeText(getContext(),"retry",Toast.LENGTH_LONG).show();
    ...
    private void doEverything(View view){
        if (isOnline()){
            ...
            hideRelatedViews();
            new JsonFetch().execute("https://networkingstone.000webhostapp.com/bank/yoma.php");
        }
        else {
            progressBar.setVisibility(View.GONE);
